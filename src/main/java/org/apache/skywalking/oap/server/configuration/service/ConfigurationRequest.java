...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ConfigurationServiceOuterClass.internal_static_ConfigurationRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ConfigurationServiceOuterClass.internal_static_ConfigurationRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ConfigurationRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    ConfigurationRequest other = (ConfigurationRequest) obj;
  ...
  public static ConfigurationRequest parseFrom(
  ...
  public static ConfigurationRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ConfigurationRequest parseFrom(
  ...
  public static ConfigurationRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ConfigurationRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ConfigurationRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ConfigurationRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public ConfigurationRequest build() {
      ConfigurationRequest result = buildPartial();
    ...
    public ConfigurationRequest buildPartial() {
      ConfigurationRequest result = new ConfigurationRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ConfigurationRequest) {
        return mergeFrom((ConfigurationRequest)other);
      } else {
    ...
    public Builder mergeFrom(ConfigurationRequest other) {
      if (other == ConfigurationRequest.getDefaultInstance()) {
        return this;
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ConfigurationRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ConfigurationRequest) e.getUnfinishedMessage();
